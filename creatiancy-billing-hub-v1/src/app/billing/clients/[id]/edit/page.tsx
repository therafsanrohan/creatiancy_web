        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-50">
            ...
            <button
              type="submit"
              disabled={saving}
              className="rounded-lg bg-[#9B1C22] py-2.5 px-6 text-xs font-semibold text-white hover:bg-[#9B1C22]/90 shadow-md transition disabled:opacity-50 cursor-pointer"
            >
